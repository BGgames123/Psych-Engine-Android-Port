...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['Creators lol'],
			['DabFunni',		'dabfunni',		'Creator of original dab mod lol',					'https://youtube.com/channel/UCpMviYnJbluA1IfMOcJffDg',	'0xFFFFDD33'],
			['BG aka Zardy',			'bg aka zardy',		'creator of fanmade dab mod',				'https://youtube.com/channel/UC6FBhAWV5D5EQvqhUq2UD5A',		'0xFFC30085'],
			[''],
			['HELPERS LOL'],
			['Maxthehedgehog',				'maxthehedgehog',			'stagemaker nothing special',						'https://twitter.com/yoshubs',			'0xFF4494E6'],
			['Bfbutcursed',		'bfbutcursed',	'.Charter',						'https://twitter.com/polybiusproxy',	'0xFFE01F32'],
